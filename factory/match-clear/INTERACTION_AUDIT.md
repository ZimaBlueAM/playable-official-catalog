...
| Pack | Board | Match | Turns | Players | Interaction note |
| --- | --- | --- | --- | --- | --- |
| Triad Current | 6×8, 4 colors | 3 | 19 | 2–6 | Six narrow columns keep vertical current swaps inside the lower one-thumb lane. |
| Prism Ladder | 5×5, 6 colors | 4 | 13 | 2–4 | The compact square keeps scarce four-line setup fully within the lower thumb sweep. |
| Pocket Comet | 9×6, 5 colors | 3 | 15 | 2–5 | Six shallow rows keep quick comet swaps concentrated in the lower active field. |
