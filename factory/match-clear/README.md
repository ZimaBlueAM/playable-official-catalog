...
Detailed lower-half one-thumb interaction evidence for batches A–Z is retained in
...
| Pack | Board | Match | Turns | Players | Interaction note |
| --- | --- | --- | --- | --- | --- |
| Dual Amber Causeway | 8×4, 6 colors | 5 | 17 | exactly 2 | Four shallow rows keep rare duel causeways inside the lower thumb sweep. |
| Open Meadow Vault | 8×7, 5 colors | 4 | 43 | 2–6 | Short local swaps keep the shared vault playable from the lower active rows. |
| Three Seat Spectrum Needle | 6×9, 8 colors | 3 | 33 | exactly 3 | Six narrow columns keep scarce three-seat needle play inside the one-thumb wiper lane. |
